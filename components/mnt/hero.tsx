...
import Icons from "@/components/mnt/global/icons";
import { Button } from "../ui/button";
import { OrbitingCircles } from "@/components/mnt/ui/OrbitingCircles";
          ...
          <Container className="relative  overflow-hidden">
            ...
            >
              ...
              <span className="z-10 py-0.5 text-sm text-neutral-100 flex items-center">
                ...
                Introducing HoloIPTV <ArrowRightIcon className="w-4 ml-2" />
              </span>
            </button>
          </Container>
